...
- **Bilingual data sources: English and Swahili job advertisements collected independently (not machine-translated). The dataset is generated by `generate_bilingual_dataset.py` and stored in `data/bilingual_job_ads.csv`**
